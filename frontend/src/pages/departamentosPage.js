  ...
  .then((response)=>{
    ...
    dataNueva.map((departamentos)=>{
      if(departamentoSelected.id_Departamento === departamentos.id_Departamento){
        ...
        departamentos.descripcionDepartamento = departamentoSelected.descripcionDepartamento;
      }
    })
          ...
          <Table striped bordered hover variant ="dark">
            ...
            {departamentos.map((departamentos)=>(
                <tr key={departamentos.id_Departamento}>
                  ...
                  <td>{departamentos.descripcionDepartamento}</td>
                  <td>
                  <Button
                      variant="success"
      ...
      <Modal show={modalInsert} onHide={OpenCloseModalInsert}>
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group >
              <Form.Label>Descripcion Del Departamento</Form.Label>
              <Form.Control name="descripcionDepartamento" onChange={handleChange} />
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
      ...
      <Modal show={modalEdit} onHide={()=>OpenCloseModalEdit()}>
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group >
              <Form.Label>Descripcion Del Departamento</Form.Label>
              <Form.Control name="descripcionDepartamento" value={departamentoSelected && departamentoSelected.descripcionDepartamento} onChange={handleChange} />
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
